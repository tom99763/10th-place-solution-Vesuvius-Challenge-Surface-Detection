...
@hydra.main(config_path="./configs", config_name="config_refinenet", version_base=None)
def run(cfg: DictConfig):
    ...
    for i in range(len(val_splits)):
        ...
        model = RefineDynUnet(cfg)
        if cfg.petrained_ckpt_path != '':
            pl_model = RefineNetModule.load_from_checkpoint(
            ...
            pl_model = RefineNetModule(model, cfg)
