...
import random
import torch
from src.datasets.scroll_dataset_pathcleaner import *
from src.trainers.pathcleanerTrainer import *
...
def run(cfg: DictConfig):
    ...
    for i in range(len(val_splits)):
        ...
        model = CleanerDynUnet(cfg)
        if cfg.petrained_ckpt_path != '':
            pl_model = CleanerRefineModule.load_from_checkpoint(
            ...
            pl_model = CleanerRefineModule(model, cfg)
